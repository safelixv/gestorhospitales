...
public class PacienteDAOMysql implements PacienteDAO {
    ...
    @Override
    public  Paciente recuperaPaciente(Integer id) throws Exception {
        try {
            MySQL.conexion();
            ...
            if (result.next()) {
                ...
                pac.setHabitacionId(result.getInt("habitacion_id"));
            }
            return pac;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @Override
    public  ArrayList<Paciente> recuperaPacientes() {
    ...
    public  void editarPacientes(Paciente paciente) {
        try {
            ...
            MySQL.updateOne(paciente.getId(), "pacientes", "habitacion_id", "" + paciente.getHabitacionId());
            MySQL.desconexion();
        } catch (Exception ex) {
    ...
    public  void altaPacientes(Paciente paciente) {
        try {
            ...
            MySQL.updateOne(id, "pacientes", "habitacion_id", "" + paciente.getHabitacionId());
            MySQL.desconexion();
        } catch (Exception ex) {
            Logger.getLogger(PacienteDAOMysql.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Override
    public  void bajapacientes(Integer id) {
        try {
            MySQL.conexion();
